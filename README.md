...
<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=cs,php,laravel,java,dotnet,css,bootstrap,materialui,html,js,ts,jquery,vuejs,pinia,react,redux,nodejs,express,mysql,sqlite,firebase,npm,git,github,docker,postman,phpstorm,eclipse,sublime,vscode,visualstudio,stackoverflow,bitbucket,notion,powershell,linux,&perline=12" />
  </a>
</p>
<br>
